# Milestone v1.4: HTML 回退路径 E2E 与可复现记录

**Status:** SHIPPED 2026-04-24  
**Phases:** 13  
**Archive source:** 收束时自 `.planning/ROADMAP.md` 全量复制；当前路线图见仓库根 `.planning/ROADMAP.md`。

## Overview

完成 **E2E-01 / E2E-02**：一书（书号 3953）在 **apibi** 与 **仅 HTML 目录**（`BQUGE_API_BASE` 不可达触发回退）下的**可复现对照**；`13-RUN-RECORD.md`、`E2E-2026-04-24.md`、README「路径对照」一句；不强制联网 CI。

---

## Archived ROADMAP body (at v1.4 close)
